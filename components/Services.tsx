...
const FEATURES = [
  {
    ...
    details: 'We create high-performance, scalable, and visually stunning websites tailored to your brand and business goals. Our team leverages the latest technologies and best practices to ensure your site is fast, secure, and optimized for conversions.'
  },
  {
    icon: FaMobileAlt,
    title: 'Mobile App Development',
    desc: 'iOS & Android, native and cross-platform mobile solutions.',
    details: 'From concept to launch, we build robust mobile apps for iOS and Android. Our expertise covers both native and cross-platform solutions, ensuring seamless user experiences and high performance on all devices.'
  },
  {
    icon: FaBuilding,
    title: 'Enterprise Software Development',
    desc: 'Robust, scalable software for enterprise operations.',
    details: 'We deliver enterprise-grade software solutions that streamline operations, boost productivity, and scale with your business. Our custom platforms are secure, reliable, and tailored to your unique requirements.'
  },
  {
    icon: FaCogs,
    title: 'Full-Stack Web App Development',
    desc: 'End-to-end web applications using modern stacks.',
    details: 'Our full-stack development team builds powerful web applications using the latest frameworks and technologies. We handle everything from frontend UI/UX to backend APIs and databases.'
  },
  {
    icon: FaPlug,
    title: 'API Development & Integration',
    desc: 'REST & GraphQL APIs, seamless third-party integrations.',
    details: 'We design and implement robust REST and GraphQL APIs, and integrate your systems with third-party services for enhanced functionality and automation.'
  },
  {
    icon: FaSyncAlt,
    title: 'App Modernization & Legacy Upgrades',
    desc: 'Upgrade and modernize legacy systems for today.',
    details: 'We help you modernize outdated applications, migrate to new platforms, and upgrade legacy systems for improved performance, security, and maintainability.'
  },
  {
    icon: FaBug,
    title: 'Bug Fixing & Optimization',
    desc: 'Debugging, performance tuning, and code fixes.',
    details: 'Our experts quickly identify and resolve bugs, optimize code, and enhance the performance and stability of your applications.'
  },
  {
    icon: FaPaintBrush,
    title: 'UI/UX Design & Optimization',
    desc: 'User-focused design and experience improvements.',
    details: 'We craft intuitive, engaging, and accessible user interfaces that delight users and drive results. Our design process is rooted in research and best practices.'
  },
  {
    icon: FaShoppingCart,
    title: 'E-Commerce Development',
    desc: 'Web and mobile stores for modern commerce.',
    details: 'We build secure, scalable, and feature-rich e-commerce platforms for web and mobile, tailored to your business model and customer needs.'
  },
  {
    icon: FaChartLine,
    title: 'SaaS Product Development',
    desc: 'Cloud-based SaaS solutions from idea to launch.',
    details: 'From MVP to full-scale SaaS products, we handle the entire development lifecycle, ensuring your solution is robust, scalable, and ready for growth.'
  },
  {
    icon: FaCloud,
    title: 'Cloud-Based App Development',
    desc: 'Build and deploy scalable cloud applications.',
    details: 'We architect, build, and deploy cloud-native applications that leverage the power and flexibility of modern cloud platforms.'
  },
  {
    icon: FaTools,
    title: 'Custom ERP & Business Solutions',
    desc: 'ERP, CRM, and business automation tailored for you.',
    details: 'We develop custom ERP, CRM, and business automation solutions that streamline your workflows and drive efficiency.'
  },
  {
    icon: FaLifeRing,
    title: 'Maintenance & Support',
    desc: 'Ongoing technical support and maintenance services.',
    details: 'Our team provides reliable, ongoing support and maintenance to keep your systems running smoothly and securely.'
  },
  {
    icon: FaLightbulb,
    title: 'Tech Consulting & Outsourcing',
    desc: 'Expert advice and project outsourcing for IT success.',
    details: 'We offer expert IT consulting and project outsourcing to help you make informed decisions and achieve your technology goals.'
  },
];
...
export default function Services({ featuredOnly = false }: ServicesProps) {
  ...
  useEffect(() => {
    if (modalOpen) {
      gsap.to('#service-modal-overlay', { opacity: 1, duration: 0.3, ease: 'power2.out' });
    } else {
      gsap.to('#service-modal-overlay', { opacity: 0, duration: 0.2, ease: 'power2.in' });
    }
  }, [modalOpen]);
      ...
      <div ref={cardsRef} className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {displayFeatures.map((f, i) => (
          <motion.div
            ...
            tabIndex={0}
            onKeyDown={e => { if (e.key === 'Enter' || e.key === ' ') { setSelected(i); setModalOpen(true); } }}
