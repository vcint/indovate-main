    ...
    >
      <div className="grid md:grid-cols-2 gap-8 mb-10">
        ...
        <div className="relative aspect-[4/3] card overflow-hidden">
          <Image src="/Images/indovatelogo2.png" alt="Indovate Technologies Logo" fill className="object-contain p-8" />
        </div>
      </div>
      <div className="grid md:grid-cols-3 gap-6 mb-10">
        ...
        <div className="card p-6">
          ...
          <p className="text-gray-600 text-sm mb-1">Led by industry veterans with 10+ years of experience in software, design, and business strategy.</p>
          <p className="text-gray-600 text-sm">We believe in hands-on leadership and direct client collaboration for every project.</p>
        </div>
        <div className="card p-6">
          <h4 className="font-semibold mb-1">Why Choose Us?</h4>
          <ul className="list-disc pl-5 text-gray-600 text-sm">
      ...
      <div className="mt-10 card p-6 bg-white/80">
        <h3 className="font-semibold text-lg mb-2">Contact & Address</h3>
        <p className="text-gray-700 mb-1">Email: <a href="mailto:sales@indovatetechnologies.com" className="text-brand-600 hover:underline">sales@indovatetechnologies.com</a></p>
        <p className="text-gray-700">2nd floor, Shinde heights, Khori Galli, Vasant Nagar, Sawe Wadi, Latur, Maharashtra 413531.</p>
      </div>
    </Section>
  );
}
